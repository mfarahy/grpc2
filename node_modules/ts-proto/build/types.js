...
function valueTypeName(ctx, typeName) {
    switch (typeName) {
        ...
        case '.google.protobuf.BytesValue':
            return ctx.options.env === options_1.EnvOption.NODE ? ts_poet_1.code `Buffer` : ts_poet_1.code `Uint8Array`;
