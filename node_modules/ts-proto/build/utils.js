...
exports.impProto = exports.determineFieldJsonName = exports.FormattedMethodDescriptor = exports.assertInstanceOf = exports.maybePrefixPackage = exports.prefixDisableLinter = exports.maybeAddComment = exports.upperFirst = exports.lowerFirst = exports.singular = exports.fail = exports.readToBuffer = exports.protoFilesToGenerate = void 0;
...
function determineFieldJsonName(field, options) {
...
exports.determineFieldJsonName = determineFieldJsonName;
function impProto(options, module, type) {
    return ts_poet_1.imp(`${type}@./${module}${options.fileSuffix}`);
}
